...
## kex-06-1: The Level-5 static secret is generated from only 256 secret bits

Severity: High
Layer: Implementation
Affected: MAMBA-NIKE-512 reference implementation and specification
Discovery: Trivial
Exploitation: Approximately 2^256 secret-seed trials
Credit: Markku-Juhani O. Saarinen <markku-juhani.saarinen@tuni.fi>, with AI assistance
Date: 2026-09-21

The MAMBA-NIKE-512 specification claims 512-bit passive key-exchange security and samples the static secret polynomial from the full centered-binomial distribution. The implementation instead derives that polynomial deterministically from one 32-byte `noiseseed`.
...
This is an implementation/specification conformance break, not a limitation of the normative secret distribution.
